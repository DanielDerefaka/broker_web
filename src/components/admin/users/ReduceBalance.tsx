...
import { ReduceBal, UpdateBal } from "@/lib/queries";
...
const ReduceBalance = ({userId}:any) => {
    ...
    <div>
      <Dialog>
        <DialogTrigger asChild>
          <Button className="w-full">Reduce Balance</Button>
        </DialogTrigger>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Reduce Balance</DialogTitle>
          </DialogHeader>
          <Form {...form}>
