    ...
    <CardContent className='grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4'>
      ...
      <div className=" flex flex-col gap-1">
        <Card className='border-[2px] border-blue-500 w-90'>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold text-blue-500">${deposit}</div>
            <p className="text-xs sm:text-sm text-muted-foreground">
              Last month ${lastMonthDeposit}
            </p>
          </CardContent>
        </Card>
        <Card className='border-[2px] border-red-500'>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold text-red-500">${withdraw}</div>
            <p className="text-xs sm:text-sm text-muted-foreground">
              Last month ${lastMonthWithdraw}
            </p>
          </CardContent>
        </Card>
      </div>
