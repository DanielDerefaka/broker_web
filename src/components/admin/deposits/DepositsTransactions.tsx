...
import { getAllDepo, approveDeposit, rejectDeposit } from "@/lib/queries";
...
const DepositsTransactions: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      const transactions = await getAllDepo();
  ...
  const handleApprove = async (id: string) => {
    try {
      ...
      const updatedTransactions = await getAllDepo();
